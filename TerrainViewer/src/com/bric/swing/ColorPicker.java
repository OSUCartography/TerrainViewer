 ...
 * @(#)ColorPicker.java
 *
 * $Date: 2009-09-20 18:24:08 -0500 (Sun, 20 Sep 2009) $
 *
...
public class ColorPicker extends JPanel {
	...
	public static Color showDialog(Window owner, String title,Color originalColor,boolean includeOpacity) {
        ...
        public static Color showDialog(Window owner, String title,Color originalColor,boolean includeOpacity, PropertyChangeListener listener) {
		ColorPickerDialog d;
		if(owner instanceof Frame || owner==null) {
			d = new ColorPickerDialog( (Frame)owner, originalColor, includeOpacity);
		} else if(owner instanceof Dialog){
		...
		d.setTitle(title == null ?
                    strings.getObject("ColorPickerDialogTitle").toString() :
                    title);
                d.cp.addPropertyChangeListener(listener);
		d.pack();
		d.setVisible(true);
		return d.getColor();
	}
