 ...
 * @(#)GradientSlider.java
 *
 * $Date: 2009-09-24 10:37:36 -0500 (Thu, 24 Sep 2009) $
 *
...
public class GradientSlider extends MultiThumbSlider {
	...
	class ColorPickerPopup extends AbstractPopup {
		...
		public ColorPickerPopup() {
			...
			boolean includeOpacity = MultiThumbSliderUI.getProperty(GradientSlider.this,"GradientSlider.colorPickerIncludesOpacity","true").equals("true");
    ...
    private boolean showColorPicker() {
        ...
        colors[i] = ColorPicker.showDialog(frame, "Select a Color", colors[i], includeOpacity, new PropertyChangeListener() {

            public void propertyChange(PropertyChangeEvent evt) {
                if (evt.getPropertyName().equals(ColorPicker.SELECTED_COLOR_PROPERTY)) {
                    colors[i] = (Color) (evt.getNewValue());
                    setValues(getThumbPositions(), colors);
                }
            }
        });
