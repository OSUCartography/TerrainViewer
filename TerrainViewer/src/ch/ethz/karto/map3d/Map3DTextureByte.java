...
/**
 * 2D single byte texture.
 * @author Bernhard Jenny, Institute of Cartography, ETH Zurich.
 */
public class Map3DTextureByte {

    private int[] textureName = new int[1];

    public Map3DTextureByte(GL gl, ByteBuffer buffer, int width, int height) {
     ...
     * @param gl
     */
    private void load(GL gl, ByteBuffer buffer, int width, int height) {
        ...
        gl.glTexImage2D(GL2.GL_TEXTURE_2D, 0, GL2.GL_LUMINANCE, width, height, 0,
